...
//            frame.append("<video id='my-player'  class='video-js vjs-big-play-centered'></video>");
            ...
            frame.append("<div id='header-right' onclick=\"document.getElementById('mask').style.display='none'\">x</div>");
            frame.append("</div>");
            frame.append("</div>");
...
/*
            ...
            frame.append("SHOW_DOWNLOAD.innerHTML = '<a onclick=\\'searchById('+inputId+')\\'>↓下载↓</a>';");
            frame.append("if(!id){");
